import { InvoiceTable, PlanSection } from "@/2-widgets/dashboard/Billing";
...
export async function BillingPage({ locale }: BillingPageProps) {
  ...
  const tabInvoices = resolveTranslation(
    translations,
    "tab.invoices",
    "Invoices",
  );
        ...
        {profile && workspace && planConfig ? (
          <Tabs defaultValue="plan">
            ...
            <TabsContent value="invoices" className="mt-6">
              <InvoiceTable invoices={invoices} translations={translations} />
            </TabsContent>
          </Tabs>
        ) : (
