...
import { getWorkspaceByProfileId, countPublishedTenants } from "@/3-features/manage-billing/actions/billingHelpers";
...
export async function getSettingsPageData(locale: string) {
  ...
  const currentSites = workspaceRow ? await countPublishedTenants(workspaceRow.id) : 0;
