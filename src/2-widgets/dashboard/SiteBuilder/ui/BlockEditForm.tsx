...
export function BlockEditForm({
  ...
  const saveTranslations = resolveTranslation(translations, "save-translations", "Save Translations");
            ...
            <div key={field.key} className="flex flex-col gap-1">
              ...
              {field.inputType === "textarea" ? (
                ...
                <>
                  ...
                  <Input id={`cfg-${field.key}`} name={field.key} type="file" accept="image/*" />
                </>
              ) : (
                <Input
                  id={field.key}
