        ...
        <div className="flex-1 flex items-center justify-center w-full h-48 md:h-[85vh]">
          {heroImage?.url ? (
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              />
              {/* Fade left overlay */}
              <div className="absolute inset-0 left-0 bg-linear-to-l from-transparent to-white/80 pointer-events-none" />
            </div>
          ) : (
            <div
              className={`w-48 h-32 md:w-64 md:h-48 rounded-xl bg-linear-to-tr from-primary/40 to-zinc-200 flex items-center justify-center`}
            >
    ...
    return (
      ...
      >
        <div className="absolute inset-0 w-full h-full rounded-xl overflow-hidden">
          ...
          {/* Faded overlay */}
          <div className="absolute inset-0 bg-linear-to-b from-zinc-100/60 to-zinc-50/80" />
        </div>
    ...
    >
      {heroImage?.url && (
        <div className="absolute inset-0 w-full h-full z-0">
          ...
          />
          {/* Faded overlay */}
          <div className="absolute inset-0 bg-linear-to-b from-white/60 to-zinc-50/80" />
        </div>
      )}
